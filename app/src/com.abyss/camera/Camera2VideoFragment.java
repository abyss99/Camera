...
public class Camera2VideoFragment extends Fragment implements View.OnClickListener {
    ...
    private static Size chooseVideoSize(Size[] choices) {
        ...
        Log.e("Camera2Video", "Couldn't find any suitable video size");
    ...
    private static Size chooseOptimalSize(Size[] choices, int width, int height, Size aspectRatio) {
        ...
        if (bigEnough.size() > 0) {
            ...
            Log.e("Camera2Video", "Couldn't find any suitable preview size");
            return choices[0];
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment2camera, container, false);
    }
